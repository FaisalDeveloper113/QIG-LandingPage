...
const Feature = () => {
    ...
    const headerStyle1 = {
        backgroundImage: 'url(https://builtin.com/sites/www.builtin.com/files/styles/og/public/2022-09/blockchain.png)',
    ...
    const headerStyle3 = {
        backgroundImage: 'url(https://www.spinutech.com/webres/Image/web-design-development/articles/Web%20Dev-Blog.png)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        height: '250px',
        display: 'flex',
                ...
                <Box sx={{
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <Typography variant="h8" color="text.secondary">
                                <ul>
                                    <li><CheckCircleIcon color="primary" />  Blockchain Wallet</li>
                                    <li><CheckCircleIcon color="primary" />  Crypto Payment Solution for eCommerce</li>
                                    <li><CheckCircleIcon color="primary" />  Savings and Lending Application</li>
                                    <li><CheckCircleIcon color="primary" />  Blockchain-Powered Investing Platform</li>
                                    <li><CheckCircleIcon color="primary" />  Decentralized Cryptocurrency Exchange</li>
                                    <li><CheckCircleIcon color="primary" />  Crowdfunding platform</li>
                                    <li><CheckCircleIcon color="primary" />  Blockchain Casino</li>
                                    <li><CheckCircleIcon color="primary" />  Play to earn game</li>
                                </ul>
                            </Typography>
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <Typography variant="h8" color="text.secondary">
                                <ul>
                                    <li><CheckCircleIcon color="primary" />  Website Design</li>
                                    <li><CheckCircleIcon color="primary" />  Front-end Development</li>
                                    <li><CheckCircleIcon color="primary" />  Back-end Development</li>
                                    <li><CheckCircleIcon color="primary" />  Full-Stack Development</li>
                                    <li><CheckCircleIcon color="primary" />  Content Management Systems (CMS)</li>
                                    <li><CheckCircleIcon color="primary" />  Website Maintenance and Support</li>
                                </ul>
                            </Typography>
                            <div className="absolute bottom-0 right-0 z-[-1]">
                                <svg
