        ...
        <>
                    ...
                    <div className=" p-4 flex flex-col md:flex-row  dark:bg-trueGray-800">
                        ...
                        <div className="flex-1 p-4">
                            <div className="flex-1 p-4 flex flex-row text-left">
                                <img width='66' height='66' src="https://yourrobotrader.com/wp-content/uploads/2023/04/YourRoboTrading-Icons-FIX_1-Breakout-Maximize-Profit.png"></img>
                                <p>Maximizes your profits by identifying and capturing breakout opportunities automatically</p>
                            </div>
                            <div className="flex-1 p-4 flex flex-row text-left">
                                <img width='66' height='66' src="https://yourrobotrader.com/wp-content/uploads/2023/04/YourRoboTrading-Icons-FIX_2-Simplify-Trading-Strategy.png"></img>
                                <p>Simplifies your trading strategy by providing automated trading signals based on technical indicators</p>
                            </div>
                            <div className="flex-1 p-4 flex flex-row text-left">
                                <img width='66' height='66' src="https://yourrobotrader.com/wp-content/uploads/2023/04/YourRoboTrading-Icons-FIX_3-Minimize-Risk-1.png"></img>
                                <p>Minimizes your risk by incorporating stop-loss orders to limit potential losses</p>
                            </div>
                            <div className="flex-1 p-4 flex flex-row text-left">
                                <img width='66' height='66' src="https://yourrobotrader.com/wp-content/uploads/2023/04/YourRoboTrading-Icons-FIX_4-Breakout-Save-Your-Time-1.png"></img>
                            ...
                            <div className="flex-1 p-4 flex flex-row text-left">
                                <img width='66' height='66' src="https://yourrobotrader.com/wp-content/uploads/2023/04/YourRoboTrading-Icons-FIX_5-Breakout-Ahead-of-the-competition.png"></img>
            ...
            <div className = " dark:bg-trueGray-800" style={{ background: '', textAlign: '-webkit-center' }}>
                <div className = " dark:bg-trueGray-800" style={{ background: 'white', maxWidth: '1300px' }}>
                    <div className="flex ">
                        <div className="flex-1"><img src="https://yourrobotrader.com/wp-content/uploads/2023/03/stock-market-analyst-looking-at-computer-trading-online-analyzing-data-.jpg"></img></div>
                        <div className="flex-1 dark:bg-trueGray-800">
                            <div className="flex-1 p-4 flex flex-row text-left">
                                <CheckCircleOutlineIcon style={{ color: '#06CA8C', marginRight:'10px' }} />
