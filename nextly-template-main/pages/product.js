...
const Product = () => {
    ...
    const productInfo2 = {
        ...
        price: 899,
        formattedPrice: "$899",
        description: "Unveiling Trend Flip - Unleash Profits with Momentum EMA Crossover Expert Advisor! Are you tired of missing out on those trend-reversal opportunities that can lead to substantial profits? Look no further! Trend Flip is your new ally in the trading world. This powerful Expert Advisor (EA) combines the precision of Exponential Moving Averages (EMA) with the prowess of momentum analysis to identify trend shifts with astounding accuracy."
    };
    ...
    const productInfo3 = {
        ...
        price: 499,
        formattedPrice: "$499",
        description: "Fortress Risk Management Algo, an exceptional MT4-based trading software designed to safeguard your investments with uncompromising precision. This algorithmic solution provides a powerful defense mechanism against unpredictable market volatility, employing dual strategies of setting a predetermined % or pip based stop loss and hedging against potential volatility spikes."
    };
    ...
    const productInfo4 = {
        ...
        price: 699,
        formattedPrice: "$699",
        description: "Simply set your desired target profits and predefined stop losses, and watch as the algorithm works its magic, closing positions with unrivaled accuracy. It's the ultimate blend of sophistication and simplicity, empowering even novice traders to achieve pro-level results. "
    };
                ...
                >
                    ...
                    <motion.div
                        ...
                        <div className="flex-1 transition-transform transform hover:scale-105 duration-500" >
                            <RecipeReviewCard  {...productInfo1} onBuyClick={() => handleCardBuyClick(productInfo1)} />
                        </div>
                    </motion.div>
                    <motion.div
                        initial="initial"
                    ...
                    <motion.div
                        ...
                        className="square">
                        <div className="flex-1 transition-transform transform hover:scale-105 duration-500">
                            <RecipeReviewCard  {...productInfo6} onBuyClick={() => handleCardBuyClick(productInfo6)} />
                        </div>
                    </motion.div>
                </div>
            </Container>
